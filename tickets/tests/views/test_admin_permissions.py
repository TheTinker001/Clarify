...
class AdminPriorityPermissionsTest(TestCase):
    ...
    def setUp(self):
        self.student = User.objects.create_user(
            username="@admstudent", email="admstudent@test.com",
            password="Password123", user_type="student",
        )
        self.staff = User.objects.create_user(
            username="@admstaff", email="admstaff@test.com",
            password="Password123", user_type="staff",
            faculties="kbs", study_levels="undergraduate", categories="other",
        )
        self.admin = User.objects.create_user(
            username="@admadmin", email="admadmin@test.com",
            password="Password123", user_type="staff", is_superuser=True,
            faculties="kbs", study_levels="undergraduate", categories="other",
        )
...
class AdminFieldsPermissionsTest(TestCase):
    ...
    def setUp(self):
        self.student = User.objects.create_user(
            username="@fldstudent", email="fldstudent@test.com",
            password="Password123", user_type="student",
        )
        self.staff = User.objects.create_user(
            username="@fldstaff", email="fldstaff@test.com",
            password="Password123", user_type="staff",
            faculties="kbs,nmes", study_levels="undergraduate", categories="other,assessment",
        )
        self.admin = User.objects.create_user(
            username="@fldadmin", email="fldadmin@test.com",
            password="Password123", user_type="staff", is_superuser=True,
            faculties="kbs,nmes", study_levels="undergraduate", categories="other,assessment",
        )
        self.ticket = Ticket.objects.create(
    ...
    def test_admin_can_edit_ticket_fields(self):
        ...
        response = self.client.post(self.url, {
            ...
            "faculty": "nmes", "study_level": "undergraduate", "category": "assessment",
        })
        self.assertEqual(response.status_code, 302)
        self.ticket.refresh_from_db()
