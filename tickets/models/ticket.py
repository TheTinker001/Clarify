...
class Ticket(models.Model):
    ...
    FACULTIES = [FOLSM, SSPP, NMPC, NMES, AH, KBS, DOCS, DPSOL, IOPPN]

    # STUDY LEVEL
    UNDERGRADUATE = ("undergraduate", "Undergraduate")
    POSTGRADUATE_TAUGHT = ("postgraduate_taught", "Postgraduate Taught")
    POSTGRADUATE = ("postgraduate", "Postgraduate")
    STUDY_LEVEL = [UNDERGRADUATE, POSTGRADUATE_TAUGHT, POSTGRADUATE]
    ...
    STATUS = [AWAITING_STAFF, AWAITING_STUDENT, CLOSED]

    # CLOSED REASONS
    ANSWERED = ("answered", "Answered")
    INACTIVITY = ("inactivity", "Inactivity")
    CLOSED_REASONS = [ANSWERED, INACTIVITY]
    ...
    faculty = models.CharField(max_length=64, choices=FACULTIES)
    study_level = models.CharField(max_length=64, choices=STUDY_LEVEL)
    ...
    status = models.CharField(max_length=32, choices=STATUS, default=AWAITING_STAFF[0])
    closed_reason = models.CharField(
        max_length=32, choices=CLOSED_REASONS, null=True, blank=True
    )
